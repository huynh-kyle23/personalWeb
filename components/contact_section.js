    ...
    <div className="relative isolate overflow-hidden bg-gray-50 py-16 sm:py-24 lg:py-32">
          ...
          <div className="max-w-xl lg:max-w-lg">
            ...
            <div className="mt-6 flex max-w-md gap-x-4">
              ...
              <input
                ...
                autoComplete="email"
                className="min-w-0 flex-auto rounded-md border-0 bg-gray-100 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-blue-500 sm:text-sm sm:leading-6"
              />
              <button
                type="submit"
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 lg:pt-2">
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-gray-100 p-2 ring-1 ring-gray-300">
                <CalendarDaysIcon aria-hidden="true" className="h-6 w-6 text-gray-900" />
              </div>
            ...
            <div className="flex flex-col items-start">
              <div className="rounded-md bg-gray-100 p-2 ring-1 ring-gray-300">
                <HandRaisedIcon aria-hidden="true" className="h-6 w-6 text-gray-900" />
              </div>
      ...
      <div aria-hidden="true" className="absolute left-1/2 top-0 -z-10 -translate-x-1/2 blur-3xl xl:-top-6">
        <div
          ...
          className="aspect-[1155/678] w-[72.1875rem] bg-gradient-to-tr from-[#add8e6] to-[#e6e6fa] opacity-30"
        />
      </div>
    </div>
  );
